const HeroSection = () => {
  return (
    <div className="rubik-doodle-shadow-regular relative bg-gradient-to-r from-blue-400 to-purple-500 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-0 max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
        <h1
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-8">
          <a
            href="/fixtures"
            className="inline-block bg-white text-gray-900 py-3 px-8 rounded-full text-lg font-semibold hover:bg-gray-100 transition duration-300"
          >
            View Fixtures
          </a>
          <a
            href="/tickets"
            className="inline-block border border-blue-500  py-3 px-8 rounded-full text-lg font-semibold bg-blue-500 text-gray-900 transition duration-300"
          >
            Get Tickets
          </a>
        </div>
